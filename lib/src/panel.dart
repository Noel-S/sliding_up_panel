                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    return Container(
                      ...
                      margin:
                          widget.margin ?? EdgeInsets.only(bottom: 30 - (_ac.value * 30), right: 15 - (_ac.value * 15), left: 15 - (_ac.value * 15)),
                      ...
                      decoration: widget.renderPanelSheet
                          ? BoxDecoration(
                              ...
                              borderRadius: widget.borderRadius ??
                                  BorderRadius.vertical(top: Radius.circular(40 - (_ac.value * 20)), bottom: Radius.circular(40 - (_ac.value * 40))),
